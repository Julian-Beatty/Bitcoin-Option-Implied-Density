...
###Your function
def polynomial(option_df,foldername,order):
    """
    ...
    #######
    #######TO DO: 
    ######Fit an N order polynomial to the IV curve
...
result_dict = {}
date_group.apply(lambda x: result_dict.update(polynomial(x,foldername="My foldername",order=5)))
